...
-   Lab 1 due Monday morning at 8 am.
    ...
    -   Submitting late and want to use your one-time waiver? Email our course coordinator [Dr. Mary Knox](https://renr213.github.io/course-team.html#course-coordinator).
...
Go to the course [GitHub org](https://github.com/sta199-f22-1) and find your `ae` repo. Clone the repo in your container, open the Quarto document called `ae-03-duke-forest`.
:::
:::::
