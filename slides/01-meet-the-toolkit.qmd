...
-   If you have not yet accepted the invite to join the course GitHub Organization
...
-   Materials:[https://w25.r4nrm.ca](#0)
...
-   gain insight from data, reproducibly **and collaboratively**, using modern 
