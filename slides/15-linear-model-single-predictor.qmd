...
Yes, I recommend the readings from the OpenIntro book for modelling, where relevant they're linked from the prepare materials.
...
## Application exercise: `ae-11-penguins-modelling`

::: appex
-   Go back to your project called `ae`.
-   If there are any uncommitted files, commit them, and push.
-   Pull, and then work on `ae-11-penguins-modelling.qmd`.
:::
