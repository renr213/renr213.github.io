...
-   **Demo:** Load the data from [https://raw.githubusercontent.com/renr213/data/refs/heads/main/age_gaps.csv](https://raw.githubusercontent.com/renr213/data/refs/heads/main/age_gaps.csv){.uri} and assign it to `age_gaps` Confirm that this new object appears in your Environment tab. 

```{r}
#| label: age-gaps-import
     
# add code here
age_gaps <- read_csv("https://raw.githubusercontent.com/renr213/data/refs/heads/main/age_gaps.csv")
glimpse(age_gaps)
```
