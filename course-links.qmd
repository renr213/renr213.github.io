...
|  |  |  |
|----|----|----|
| Course GitHub organization | 🔗 on [GitHub](https://github.com/renr213) \| |  |
|  |  |  |

+-----------------------+-----------------------------------------------------------------------------+
| Discussion            | 🔗 on [Canvas](https://edstem.org/us/courses/50730/discussion/)             |
+-----------------------+-----------------------------------------------------------------------------+
| Class recordings      | 🔗 on ca                                                                    |
+-----------------------+-----------------------------------------------------------------------------+
| Canvas            | 🔗 on [Canvas](https://canvas.duke.edu/courses/26106/external_tools/181)    |
+-----------------------+-----------------------------------------------------------------------------+
