...
Create a student account on Posit Cloud at <https://posit.cloud/plans>. This will cost you \$5/month and gives you 75 hours/month of compute hours.

Alternatively, you can create a free account which gives you 25 hours/month of compute hours. You can upgrade to a student account later if you need to.
...
You will authenticate GitHub using SSH (Secure Shell Protocol – it doesn't really matter what this means for the purpose of this course). Below is an outline of the authentication steps; you are encouraged to follow along as your instructor the steps.

::: callout-note
You only need to do this authentication process one time on a single system.
:::

-   Go back to your RStudio instance on Posit Cloud and type `install.packages("credentials")` into your console. You will see a number of information messages about the installation of the credentials package.
-   Then type `credentials::ssh_setup_github()` into your console.
-   R will ask "No SSH key found. Generate one now?" You should click 1 for yes.
-   You will generate a key. It will begin with "ecdsa-sha2...." R will then ask "Would you like to open a browser now?" First you should copy the key to your clipboard, and then you should click 1 for yes.
-   You may be asked to provide your GitHub username and password to log into GitHub. After entering this information, you should paste the key in and give it a name. You might name it in a way that indicates where the key will be used, e.g., `renr213`).
...
usethis::use_git_config(
  user.name = "Glen Armstrong", 
  user.email = "glen.armstrong@ualberta.ca"
)
```
