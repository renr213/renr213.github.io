...
-   Go to the course organization at [github.com/renr213](https://github.com/renr213) organization on GitHub. Click on the repo with the prefix **lab-1**. It contains the starter documents you need to complete the lab.
