...
::: callout-important
This question requires no code, only narrative. Remember that, based on the [syllabus](https://renr213-s24.github.io/course-syllabus.html#academic-honesty), you may not use generative AI tools (e.g., Chat GPT) to write narrative on assignments.
:::
