...
Explain the reasoning for the types of analyses you do, exploratory, inferential, or modelling.
If you've chosen to do inference, make sure to include a justification for why that inferential approach is appropriate.
If you've chosen to do modelling, describe the model(s) you're fitting, predictor variables considered for the model including any interactions.
...
-   Slide 4-5: Inference/modelling/other analysis
